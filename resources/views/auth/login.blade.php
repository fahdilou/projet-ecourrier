              ...
              <div class="col-md-7 col-lg-12 col-xl-9">
                <div>
                  <span class="db" style="display: inline-block;">
                    <img src="{{ asset('assets/images/logo-new1.png') }}" alt="logo">
                </span>
                ...
                <h2 class="text-white mt-4 fw-light">
                  Bienvenue sur eCourrier - Votre plateforme de gestion des courriers  !
                </h2>
          ...
          <div class="row justify-content-center w-100 mt-4 mt-lg-0">
            <div class="col-lg-4 col-md-6">
              ...
              <div class="card" id="loginform">
                <div class="card-body">
                  <h2>Bienvenue sur {{ config('app.name', 'Laravel') }}</h2>
                  ...
                  <form id="formAuthentication"  autocomplete="off" method="POST" action="{{ route('login.authentification') }}"
                    class="form-horizontal mt-4 pt-4 needs-validation"
