...
$("#file_export").DataTable({
  ...
  scrollX: true,
  language: {
    url: "assets/plugins/datatable/french.json" // Spécifier l'emplacement du fichier French.json
  },
});
$(
...
$("#table_enregitrement").DataTable({
  ...
  scrollX: true,
  language: {
    url: "assets/plugins/datapublic/assets/dist/js/pages/datatable/datatable-advanced.init.jstable/french.json" // Spécifier l'emplacement du fichier French.json
  },
});
$(
  ".buttons-copy, .buttons-csv, .buttons-print, .buttons-pdf, .buttons-excel"
